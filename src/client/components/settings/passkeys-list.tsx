...
import type { ParsedUserAgent } from "@/shared/types";
...
function PasskeyRegistrationButton({ email, className, onSuccess }: PasskeyRegistrationButtonProps) {
  ...
  const handleRegister = async () => {
    try {
      ...
      const optionsResponse = await apiClient.post('/auth/passkey/register-options', { email });
                      ...
                      <DialogContent>
                        ...
                        <DialogFooter className="mt-6 sm:mt-0">
                          ...
                          <Button
                            ...
                            onClick={() => deletePasskeyMutation.mutate(passkey.credentialId)}
                          >
                            Delete passkey
                          </Button>
                        </DialogFooter>
