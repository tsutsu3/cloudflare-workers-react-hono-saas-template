...
import { GITHUB_REPO_URL, SITE_NAME } from "@/shared/constants";
import { Button } from "./ui/button";
import AgenticDevStudioLogo from "./agenticdev-studio-logo";
// TODO: This needs to be fetched via API in client-side
// import { getGithubStars } from "@/server/utils/stats";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-6">
            ...
            <div className="space-y-3 md:space-y-4 flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-2 flex flex-col items-center md:items-start">
                <li>
                  <Link to="/terms" className="text-sm text-muted-foreground hover:text-foreground text-center md:text-left">
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link to="/privacy" className="text-sm text-muted-foreground hover:text-foreground text-center md:text-left">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-3 md:space-y-4 flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-2 flex flex-col items-center md:items-start">
                <li>
                  <Link to="/" className="text-sm text-muted-foreground hover:text-foreground text-center md:text-left">
                    Home
                  </Link>
                </li>
              </ul>
...
// GitHub button with stars (client-side fetch)
function GithubButton() {
  // TODO: Fetch stars via API using TanStack Query
  return (
