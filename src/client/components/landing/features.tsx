...
const features = [
  {
    ...
    description:
      "Complete authentication system with email/password sign in, sign up, forgot password flow, and session management.",
  ...
  },
  {
    name: "Modern Stack",
    description:
      "React 19 with TanStack Router, Hono API backend, and Edge Runtime for optimal performance.",
    icon: BoltIcon,
  },
  {
    name: "Beautiful UI",
