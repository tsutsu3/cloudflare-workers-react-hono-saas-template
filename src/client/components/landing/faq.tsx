  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          <li>Update project details in <code>src/shared/constants.ts</code></li>
          <li>Customize the documentation in <code>./cursor-docs</code></li>
          <li>Modify the footer in <code>src/client/components/footer.tsx</code></li>
          <li>Optionally update the color palette in <code>src/client/styles/globals.css</code></li>
        </ul>
      </>
    ),
  },
