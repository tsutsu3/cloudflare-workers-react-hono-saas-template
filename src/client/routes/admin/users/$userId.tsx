      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <PageHeader
          items={[
            ...
            { href: `/admin/users/${userId}`, label: "Loading..." }
          ]}
        />
      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <PageHeader
          items={[
            { href: "/admin", label: "Admin" },
            { href: "/admin", label: "Users" },
            { href: `/admin/users/${userId}`, label: "User Not Found" }
          ]}
        />
            ...
            <CardContent className="space-y-4">
              ...
              {user.emailVerified && (
                <div>
                  ...
                  <p className="text-sm">{format(new Date(user.emailVerified), "PPpp")}</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              {user.lastCreditRefreshAt && (
                <div>
                  ...
                  <p className="text-sm">{format(new Date(user.lastCreditRefreshAt), "PPpp")}</p>
                </div>
              )}
            </CardContent>
          </Card>
                    ...
                    <div key={passkey.id} className="border rounded-lg p-3 space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge variant="secondary" className="text-xs">
                          {format(new Date(passkey.createdAt), "MMM dd, yyyy")}
                        </Badge>
                      </div>
